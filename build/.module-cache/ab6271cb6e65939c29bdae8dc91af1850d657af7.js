var ToDoList = React.createClass({displayName: "ToDoList",
    ...
    addToList: function(newText) {
        ...
        tasksArr.push({ text: newText, completed: false }); // Add completed property
        this.setState({tasks: tasksArr });
      },
      
      saveList: function(newText, i) {
        var tasksArr = this.state.tasks;
        tasksArr[i] = { text: newText, completed: tasksArr[i].completed }; // Update completed state
        this.setState({tasks: tasksArr });
      },
    ...
    eachTask: function(task, i) {
        return (
            ...
            React.createElement(ToDo, {index: i, onSave: this.saveList, onDelete: this.deleteFromList, completed: task.completed}, task)
        )
    },
    render: function() {
        return (
