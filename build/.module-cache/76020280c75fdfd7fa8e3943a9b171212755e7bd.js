var ToDo = React.createClass({displayName: "ToDo",
    ...
    renderDefaultCard: function() {
        return(
            ...
            React.createElement("input", {type: "checkbox", checked: this.props.completed, onChange: this.toggleCompleted}), " ", React.createElement("h3", null, this.props.children), 
    ...
    renderEditCard: function() {
        return(
            React.createElement("div", {className: "todo"}, 
            React.createElement("input", {type: "checkbox", checked: this.props.completed, onChange: this.toggleCompleted}), 
